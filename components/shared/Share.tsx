...
const Share: React.FC<shareProps> = ({ userId }) => {
  ...
  const shareTitle = "OFFERUP | Buy & Sell";
  const shareUrl = `https://offerup.com/shop/${userId}`;

  const shareDescription = `Discover all the amazing products I'm selling on my OfferUp shop! Check them out here: ${shareUrl} #ShopNow #OfferUpDeals #ExclusiveProducts `;
