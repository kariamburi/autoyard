...
const AdminNavItems = ({ onDataFromChild }: any) => {
        ...
        return (
          ...
          >
            <Link href={link.route}>
              <div className="flex hover:bg-emerald-100 hover:rounded-full hover:text-emerald-600 p-3 mb-1 hover:cursor-pointer">
