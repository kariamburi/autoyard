...
const HorizontalCard = ({
  ...
  const sliderSettings = {
    ...
    appendDots: (dots: any) => (
      <div style={{ bottom: "0px", width: "100%", overflow: "hidden" }}>
        <div
        ...
        <div className="relative w-[180px] lg:w-[250px] h-[210px]">
          ...
          {isbookmark && (
            <div className="w-full flex justify-end  absolute top-2/3 left-1/2 transform -translate-x-1/2 p-1 rounded-full">
              <div
                className="w-8 h-8 p-1 mt-[-20px] shadow-[0px_4px_20px_rgba(0,0,0,0.3)] flex items-center justify-center rounded-full bg-red-100 text-emerald-500 tooltip tooltip-bottom hover:text-[#2BBF4E] hover:cursor-pointer"
                data-tip="Bookmark"
        ...
        <div className="flex-1 mt-2 p-2">
          ...
          <div className="flex justify-between w-full">
            <div className="flex gap-1 mt-1">
              {ad.vehiclecondition && (
                <div className="flex gap-1 text-[8px] lg:text-xs bg-[#ebf2f7] rounded-sm p-1 items-center justify-center border">
                  {ad.vehiclecondition}
                </div>
              )}
